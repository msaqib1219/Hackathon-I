...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "E:\\PIAIC\\Hackathon I\\sidebars.js",
          "remarkPlugins": [
            null
          ],
          "rehypePlugins": [
        ...
        "theme": {
          "customCss": "E:\\PIAIC\\Hackathon I\\src\\css\\custom.css"
        },
        "blog": false
      }
    ]
  ...
  "themeConfig": {
    ...
    "footer": {
      "style": "dark",
      "copyright": "Copyright © 2026 Agentic AI Book. Built with Docusaurus.",
      "links": []
    },
    "colorMode": {
      "defaultMode": "light",
